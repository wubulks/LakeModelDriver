...
!  ------------------------- inout variables ---------------------------
   ...
   real(r8), intent(inout)  :: &
      ...
      zissb(-nsnow:nsoil)     ,&! soil + snow layer interface level [m]
...
!================================================================================
      ...
      ENDDO 
      lb = snlay+1
      IF (.not. DEF_External_Lake%DEF_USE_SURFACE_LAYER) THEN
...
!  ------------------------- inout variables ---------------------------
   ...
   real(r8), intent(inout) :: zi_soisno(maxsnl:nl_soil)   ! interface level below a "z" level (m)
...
! ======================================================================
      ...
      ENDIF
      ! If the surface layer flux scheme is used, this calculation is incorrect,
      ! because the energy changes caused by precipitation are not included.
#endif
